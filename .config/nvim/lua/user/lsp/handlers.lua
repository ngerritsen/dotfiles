...
-- Disable formatting for following LSP's to prevent conflicts with null-ls
...
local function lsp_keymaps(bufnr)
	...
	map(bufnr, "n", "<leader>ri", "<cmd>lua vim.lsp.buf.hover()<CR>", opts)
	map(bufnr, "n", "<leader>rs", "<cmd>lua vim.lsp.buf.signature_help()<CR>", opts)
	map(bufnr, "n", "<leader>rn", "<cmd>lua vim.lsp.buf.rename()<CR>", opts)
	map(bufnr, "n", "<leader>rf", "<cmd>lua vim.lsp.buf.code_action()<CR>", opts)
